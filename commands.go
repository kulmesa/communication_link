...
func handleControlCommands(ctx context.Context, wg *sync.WaitGroup, mqttClient mqtt.Client, node *ros.RosNode, commands <-chan string) {
	wg.Add(1)
	defer wg.Done()
...
func handleMissionCommands(ctx context.Context, wg *sync.WaitGroup, node *ros.RosNode, commands <-chan string) {
	wg.Add(1)
	defer wg.Done()
...
func handleGstreamerCommands(ctx context.Context, wg *sync.WaitGroup, node *ros.RosNode, commands <-chan string) {
	wg.Add(1)
	defer wg.Done()
...
func startCommandHandlers(ctx context.Context, wg *sync.WaitGroup, mqttClient mqtt.Client, node *ros.RosNode) {
